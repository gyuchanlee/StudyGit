...
public class QAuthor extends EntityPathBase<Author> {
    ...
    private static final long serialVersionUID = -1640391105L;

    public static final QAuthor author = new QAuthor("author");

    public final StringPath bio = createString("bio");

    public final SetPath<Course, QCourse> courses = this.<Course, QCourse>createSet("courses", Course.class, QCourse.class, PathInits.DIRECT2);
